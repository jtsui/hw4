...
Problem 4.
Run crossval.py. Tunable parameters include threshold, learning rate, and a regularization weight passed in as a command line argument. For each value in regularization weight, will run 5 fold cross validation and output the average error, writing it to a file as well.
